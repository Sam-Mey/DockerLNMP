...
GD_LIB_SCRIPT_PATH="$SCRIPT_DIR/lnmp/build/php/lib/gd_lib.sh"
...
INSTALL_PHP_MODULES_SCRIPT_PATH="$SCRIPT_DIR/lnmp/build/php/lib/extension/install_php_modules.sh"
...
WEBSITE_SCRIPT_PATH="$SCRIPT_DIR/submenu/website.sh"
...
# echo "WEBSITE_SCRIPT_PATH: $WEBSITE_SCRIPT_PATH"
