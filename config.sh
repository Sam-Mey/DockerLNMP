...
10-LISTEN-ON-IPV6-BY-DEFAULT_SCRIPT_PATH="$SCRIPT_DIR/lnmp/nginx/debian/10-listen-on-ipv6-by-default.sh"
20-ENVSUBST-ON-TEMPLATES_SCRIPT_PATH="$SCRIPT_DIR/lnmp/nginx/debian/20-envsubst-on-templates.sh"
30-TUNE-WORKER-PROCESSES_SCRIPT_PATH="$SCRIPT_DIR/lnmp/nginx/debian/30-tune-worker-processes.sh"
...
DOCKER-ENTRYPOINT_SCRIPT_PATH="$SCRIPT_DIR/lnmp/database/11.2/docker-entrypoint.sh"
DOCKER-ENTRYPOINT_SCRIPT_PATH="$SCRIPT_DIR/lnmp/nginx/debian/docker-entrypoint.sh"
DOCKER-ENTRYPOINT_SCRIPT_PATH="$SCRIPT_DIR/lnmp/phpmyadmin/apache/docker-entrypoint.sh"
DOCKER-ENTRYPOINT_SCRIPT_PATH="$SCRIPT_DIR/lnmp/redis/7.2/alpine/docker-entrypoint.sh"
DOCKER-ENTRYPOINT_SCRIPT_PATH="$SCRIPT_DIR/lnmp/redis/7.2/debian/docker-entrypoint.sh"
DOCKER_SCRIPT_PATH="$SCRIPT_DIR/docker/docker.sh"
GD_LIB_SCRIPT_PATH="$SCRIPT_DIR/commands/gd_lib.sh"
GET_LNMP_SCRIPT_PATH="$SCRIPT_DIR/commands/get_lnmp.sh"
HEALTHCHECK_SCRIPT_PATH="$SCRIPT_DIR/lnmp/database/11.2/healthcheck.sh"
...
RECOVER_OVERCOMMIT_MEMORY_SCRIPT_PATH="$SCRIPT_DIR/commands/recover_overcommit_memory.sh"
...
RUN_LNMP_SCRIPT_PATH="$SCRIPT_DIR/commands/run_lnmp.sh"
SET_OVERCOMMIT_MEMORY_SCRIPT_PATH="$SCRIPT_DIR/commands/set_overcommit_memory.sh"
...
# # path debug
# echo "10-LISTEN-ON-IPV6-BY-DEFAULT_SCRIPT_PATH: $10-LISTEN-ON-IPV6-BY-DEFAULT_SCRIPT_PATH"
# echo "20-ENVSUBST-ON-TEMPLATES_SCRIPT_PATH: $20-ENVSUBST-ON-TEMPLATES_SCRIPT_PATH"
# echo "30-TUNE-WORKER-PROCESSES_SCRIPT_PATH: $30-TUNE-WORKER-PROCESSES_SCRIPT_PATH"
...
# echo "DOCKER-ENTRYPOINT_SCRIPT_PATH: $DOCKER-ENTRYPOINT_SCRIPT_PATH"
# echo "DOCKER-ENTRYPOINT_SCRIPT_PATH: $DOCKER-ENTRYPOINT_SCRIPT_PATH"
# echo "DOCKER-ENTRYPOINT_SCRIPT_PATH: $DOCKER-ENTRYPOINT_SCRIPT_PATH"
# echo "DOCKER-ENTRYPOINT_SCRIPT_PATH: $DOCKER-ENTRYPOINT_SCRIPT_PATH"
# echo "DOCKER-ENTRYPOINT_SCRIPT_PATH: $DOCKER-ENTRYPOINT_SCRIPT_PATH"
...
# echo "HEALTHCHECK_SCRIPT_PATH: $HEALTHCHECK_SCRIPT_PATH"
...
# echo "RUN_LNMP_SCRIPT_PATH: $RUN_LNMP_SCRIPT_PATH"
